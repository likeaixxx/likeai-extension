                ...
                actions={
                    <ActionPanel>
                        ...
                        <Action
                            ...
                            title="Refresh"
                            onAction={() => open(`raycast://extensions/mattisssa/spotify-player/lyricsAppFind?arguments=%7B%22refresh%22%3A%22true%22%7D`)}
                        />
                    </ActionPanel>
                }
            />
                            ...
                            <ActionPanel>
                                {
                                    ...
                                    <Action icon={Icon.Checkmark} title="Confirm"
                                        onAction={async () => {
                                            ...
                                            await open(`raycast://extensions/mattisssa/spotify-player/lyricsAppFind?arguments=%7B%22refresh%22%3A%22%22%7D`)
                                        }} />
                                }
